      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Bukti pembayaran</button>
            </li>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <form>
                <div class="row mb-3">
                  <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Bukti pembayaran</label>
                ...
                <div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nomor Rekening</label>
                  <div class="col-md-8 col-lg-9">
